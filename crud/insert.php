...
if(isset($_POST['submit']))
  {
    ...
    $add=$_POST['address'];
     ...
     $query=mysqli_query($con, "insert into tblusers(FirstName,LastName, MobileNumber, Email, Address) 
     	value('$fname','$lname', '$contno', '$email', '$add' )");
    if ($query) {
    ...
    <form  method="POST">
		...
		<div class="form-group">
            <button type="submit" class="btn btn-success btn-lg btn-block" name="submit">Submit</button>
              <a href="index.php"><button type="button" class="btn btn-primary"><span class="cil-contrast btn-icon mr-2"></span> BACK</button> 
              	 <a href="index.php"><button type="button" class="btn btn-primary"><span class="cil-contrast btn-icon mr-2"></span>VIEW</button>
              		<div class="text-center">View Aready Inserted Data!! 
        </div>
    </form>
